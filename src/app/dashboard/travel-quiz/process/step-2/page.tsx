...
const QuizStep2Page = () => {
  ...
  return (
    <aside className="flex h-full items-center justify-start flex-col py-10 mx-auto">
      ...
      <section className="flex flex-row flex-wrap gap-4 justify-center mt-9">
      ...
      <section className="mt-9 pb-10">
        <Button
          ...
          onClick={() => {
            decrementQuizSep();
            router.push(APP_ROUTES.QUIZ_STEP_1);
          }}
        >
          Back
        </Button>
        <Button
          ...
          onClick={() => {
            incrementQuizSep();
            router.push(APP_ROUTES.QUIZ_STEP_3);
          }}
        >
          Next
        </Button>
